...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  [ChainId.DYNO]: [WNATIVE[ChainId.DYNO], DUSD[ChainId.DYNO], USDT[ChainId.DYNO]],
}
 ...
 * tokens.
 * @example [AMPL.address]: [DAI, WNATIVE[ChainId.DYNO]]
 */
...
// BNB
export const DEFAULT_INPUT_CURRENCY = 'DND'
// CAKE
